...
/** the dialect seam: only spellings live here, protocol law stays in the builders. */
...
/** every builder input in one bag; an op outside `operators` is refused before it renders. */
